...
class SelectLanguageCountryView extends ConsumerWidget {
  SelectLanguageCountryView({super.key});
        ...
        CustomButton(
          ...
          onPressed:
              (ref.read(selectedCountryProvider) != null &&
                      ref.read(selectedLanguageProvider) != null) &&
                  (ref.read(selectedCountryProvider)!.isNotEmpty &&
                      ref.read(selectedLanguageProvider)!.isNotEmpty)
              ? () {
                  if (index < 1) {
